...
import { WorkspaceMemberWithUser, WorkspaceRole, WORKSPACE_ROLES } from "@/lib/types/team"
                        ...
                        {Object.values(WORKSPACE_ROLES).map((role) => (
                          <SelectItem key={role.id} value={role.id}>
                            <div className="flex items-center space-x-2">
                              {getRoleIcon(role.id as WorkspaceRole)}
                              <span>{role.name}</span>
                            </div>
                          </SelectItem>
                        ))}
            ...
            <div key={member.id} className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <Badge className={`${getRoleColor(member.role)} flex items-center space-x-1`}>
                  ...
                  <span>{WORKSPACE_ROLES[member.role].name}</span>
                </Badge>
                {canManage && (
                  <DropdownMenu>
